var quotes = {
  ...
  "19":
      {"quote":"Perl â€“ The only language that looks the same before and after RSA encryption.","author":"Keith Bostic"},
  "20":
  ...
  "26":
      {"quote":"A computer is like a violin. You can imagine a novice trying ï¬rst a phonograph and then a violin. The latter, he says, sounds terrible. That is the argument we have heard from our humanists and most of our computer scientists. Computer programs are good, they say, for particular purposes, but they arenâ€™t ï¬‚exible. Neither is a violin, or a typewriter, until you learn how to use it.","author":"Marvin Minsky"},
  "27":
  ...
  "29":
      {"quote":"At forty, I was too old to work as a programmer myself anymore; writing code is a young personâ€™s job.","author":"Michael Crichton, Prey"},
  "30":
      {"quote":"I think that itâ€™s extraordinarily important that we in computer science keep fun in computing. When it started out it was an awful lot of fun. Of course the paying customers got shafted every now and then and after a while we began to take their complaints seriously. We began to feel as if we really were responsible for the successful error-free perfect use of these machines. I donâ€™t think we are. I think weâ€™re responsible for stretching them setting them off in new directions and keeping fun in the house. I hope the ï¬eld of computer science never loses its sense of fun. Above all I hope we donâ€™t become missionaries. Donâ€™t feel as if youâ€™re Bible sales-men. The world has too many of those already. What you know about computing other people will learn. Donâ€™t feel as if the key to successful computing is only in your hands. Whatâ€™s in your hands I think and hope is intelligence: the ability to see the machine as more than when you were ï¬rst led up to it that you can make it more.","author":"Alan J. Perlis"},
  "31":
  ...
  "43":
      {"quote":"What's in your hands I think and hope is intelligence: the ability to see the machine as more than when you were ï¬rst led up to it that you can make it more.","author":"Alan J. Perlis"},
  "44":
  ...
  "48":
      {"quote":"You should imagine variables as tentacles, rather than boxes. They do not contain values; they grasp themâ€”two variables can refer to the same value.","author":"Marijn Haverbeke, Eloquent JavaScript: A Modern Introduction to Programming"},
  "49":
  ...
  "76":
      {"quote":"Mais importante do que aprender a programar numa linguagem de programaÃ§Ã£o, Ã© compreender os conceitos que sÃ£o aplicados a todas as linguagens.","author":"Jalerson Lima, ProgramaÃ§Ã£o Estruturada e Orientada a Objetos: Caderno de Aulas"},
  "77":
  ...
  "80":
      {"quote":"we are writing our own â€ª#â€Žkarmaâ€¬! I mean my test cases","author":"ahkeno"},
  "81":
  ...
  "92":
      {"quote":"Programming, it turns out, is hard. The fundamental rules are typically simple and clear. But programs built on top of these rules tend to become complex enough to introduce their own rules and complexity. Youâ€™re building your own maze, in a way, and you might just get lost in it.","author":"Marijn Haverbeke"},
  "93":
  ...
  "112":
      {"quote":"...Iâ€™m not saying simple code takes less time to write. Youâ€™d think it would since you end up with less total code, but a good solution isnâ€™t an accretion of code, itâ€™s a distillation of it.","author":"Robert Nystrom"},
  "113":
  ...
  "120":
      {"quote":"If you've never programmed a computer, you should. There's nothing like it in the whole world. When you program a computer, it does exactly what you tell it to do. It's like designing a machine â€” any machine, like a car, like a faucet, like a gas-hinge for a door â€” using math and instructions. It's awesome in the truest sense: it can fill you with awe.","author":"Cory Doctorow, Little Brother"},
  "121":
  ...
  "123":
      {"quote":"Also, look for â€œfloating alters.â€ These are not deliberately created parts of the system, but alters that were accidentally split off at the same time as others.","author":"Alison Miller, Healing the Unimaginable: Treating Ritual Abuse and Mind Control"},
  "124":
  ...
  "128":
      {"quote":"Carmack was of the moment. His ruling force was focus. Time existed for him not in some promising future or sentimental past but in the present condition, the intricate web ol problems and solutions, imagination and code. He kept nothing from the pastâ€“no pictures, no records, no games, no computer disks. He didnâ€™t even save copies of his first games, Wraith and Shadowforge. There was no yearbook to remind of his time at Shadowforge. There was no yearbook to remind of his time at school, no magazine copies of his early publications. He kept nothing but what he needed at the time. His bedroom consisted of a lamp, a pillow, a blanket, and a stack of books. There was no mattress. All he brought with him from home was a cat named Mitzi (a gift from his stepfamily) with a mean streak and a reckless bladder.","author":"David Kushner, Masters of Doom: How Two Guys Created an Empire and Transformed Pop Culture"},
  "129":
  ...
  "142":
      {"quote":"Kids who are good at traditional schoolâ€”repeating rote concepts and facts on a testâ€”can fall apart in a situation where that isnâ€™t enough. Programming rewards the experimental, curious mind.","author":"Ketil Moland Olsen"},
  "143":
  ...
  "159":
      {"quote":"Legacy code. The phrase strikes disgust in the hearts of programmers. It conjures images of slogging through a murky swamp of tangled undergrowth with leaches beneath and stinging flies above. It conjures odors of murk, slime, stagnancy, and offal. Although our first joy of programming may have been intense, the misery of dealing with legacy code is often sufficient to extinguish that flame.ï»¿","author":"Michael C. Feathers, Working Effectively with Legacy Code"},
  "160":
  ...
  "161":
      {"quote":"Sometimes abstraction and encapsulation are at odds with performance â€” although not nearly as often as many developers believe â€” but it is always a good practice first to make your code right, and then make it fast.","author":"Brian Goetz, Java Concurrency in Practice"},
  "162":
  ...
  "178":
      {"quote":"Thatâ€™s whatâ€™s cool about working with computers. They donâ€™t argue, they remember everything, and they donâ€™t drink all your beer.","author":"Paul Leary"},
  "179":
  ...
  "180":
      {"quote":"Computers are getting smarter all the time. Scientists tell us that soon they will be able to talk to us. (And by â€˜theyâ€™, I mean â€˜computersâ€™. I doubt scientists will ever be able to talk to us.)","author":"Dave Barry"},
  "181":
      {"quote":"Iâ€™ve noticed lately that the paranoid fear of computers becoming intelligent and taking over the world has almost entirely disappeared from the common culture. Near as I can tell, this coincides with the release of MS-DOS.","author":"Larry DeLuca"},
  "182":
  ...
  "183":
      {"quote":"Itâ€™s ridiculous to live 100 years and only be able to remember 30 million bytes. You know, less than a compact disc. The human condition is really becoming more obsolete every minute.","author":"Marvin Minsky"},
  "184":
      {"quote":"The cityâ€™s central computer told you? R2D2, you know better than to trust a strange computer!","author":"C3PO"},
  "185":
      {"quote":"Never trust a computer you canâ€™t throw out a window.","author":"Steve Wozniak"},
  "186":
  ...
  "188":
      {"quote":"Iâ€™ve finally learned what â€˜upward compatibleâ€™ means. It means we get to keep all our old mistakes.","author":"Dennie van Tassel"},
  "189":
      {"quote":"There are two major products that come out of Berkeley: LSD and UNIX. We donâ€™t believe this to be a coincidence.","author":"Jeremy S. Anderson"},
  "190":
      {"quote":"19 Jan 2038 at 3:14:07 AM","author":"End of the word according to Unixâ€“2^32 seconds after January 1, 1970"},
  "191":
      {"quote":"Every operating system out there is about equalâ€¦ We all suck.","author":"Microsoft senior vice president Brian Valentine describing the state of the art in OS security, 2003"},
  "192":
      {"quote":"Microsoft has a new version out, Windows XP, which according to everybody is the â€˜most reliable Windows ever.â€˜ To me, this is like saying that asparagus is â€˜the most articulate vegetable ever.","author":"Dave Barry"},
  "193":
  ...
  "202":
      {"quote":"The bulk of all patents are crap. Spending time reading them is stupid. Itâ€™s up to the patent owner to do so, and to enforce them.","author":"Linus Torvalds"},
  "203":
  ...
  "207":
      {"quote":"Just remember: youâ€™re not a â€˜dummy,â€™ no matter what those computer books claim. The real dummies are the people whoâ€“though technically expertâ€“couldnâ€™t design hardware and software thatâ€™s usable by normal consumers if their lives depended upon it.","author":"Walter Mossberg"},
  "208":
      {"quote":"Software suppliers are trying to make their software packages more â€˜user-friendlyâ€™â€¦ Their best approach so far has been to take all the old brochures and stamp the words â€˜user-friendlyâ€™ on the cover.","author":"Bill Gates"},
  "209":
      {"quote":"Thereâ€™s an old story about the person who wished his computer were as easy to use as his telephone. That wish has come true, since I no longer know how to use my telephone.","author":"Bjarne Stroustrup"},
  "210":
      {"quote":"Any fool can use a computer. Many do.","author":"Ted Nelson"},
  "211":
      {"quote":"There are only two industries that refer to their customers as â€˜usersâ€™.","author":"Edward Tufte"},
  "212":
  ...
  "214":
      {"quote":"The trouble with programmers is that you can never tell what a programmer is doing until itâ€™s too late.","author":"Seymour Cray"},
  "215":
      {"quote":"Thatâ€™s the thing about people who think they hate computers. What they really hate is lousy programmers.","author":"Larry Niven"},
  "216":
  ...
  "222":
      {"quote":"Donâ€™t worry if it doesnâ€™t work right. If everything did, youâ€™d be out of a job.","author":"Mosherâ€™s Law of Software Engineering"},
  "223":
  ...
  "235":
      {"quote":"I think Microsoft named .Net so it wouldnâ€™t show up in a Unix directory listing.","author":"Oktal"},
  "236":
      {"quote":"There is no programming languageâ€“no matter how structuredâ€“that will prevent programmers from making bad programs.","author":"Larry Flon"},
  "237":
      {"quote":"Computer language design is just like a stroll in the park. Jurassic Park, that is.","author":"Larry Wall"},
  "238":
      {"quote":"Fifty years of programming language research, and we end up with C++?","author":"Richard A. Oâ€™Keefe"},
  "239":
      {"quote":"Writing in C or C++ is like running a chain saw with all the safety guards removed.","author":"Bob Gray"},
  "240":
      {"quote":"In C++ itâ€™s harder to shoot yourself in the foot, but when you do, you blow off your whole leg.","author":"Bjarne Stroustrup"},
  "241":
      {"quote":"C++ : Where friends have access to your private members.","author":"Gavin Russell Baker"},
  "242":
      {"quote":"One of the main causes of the fall of the Roman Empire was thatâ€“lacking zeroâ€“they had no way to indicate successful termination of their C programs.","author":"Robert Firth"},
  "243":
      {"quote":"Java is, in many ways, C++â€“.","author":"Michael Feldman"},
  "244":
      {"quote":"Fine, Java MIGHT be a good example of what a programming language should be like. But Java applications are good examples of what applications SHOULDNâ€™T be like.","author":"pixadel"},
  "245":
  ...
  "248":
      {"quote":"Any code of your own that you havenâ€™t looked at for six or more months might as well have been written by someone else.","author":"Eaglesonâ€™s Law"},
  "249":
  ...
  "251":
      {"quote":"In software, we rarely have meaningful requirements. Even if we do, the only measure of success that matters is whether our solution solves the customerâ€™s shifting idea of what their problem is.","author":"Jeff Atwood"},
  "252":
  ...
  "253":
      {"quote":"You canâ€™t have great software without a great team, and most software teams behave like dysfunctional families.","author":"Jim McCarthy"},
  "254":
      {"quote":"As soon as we started programming, we found to our surprise that it wasnâ€™t as easy to get programs right as we had thought. Debugging had to be discovered. I can remember the exact instant when I realized that a large part of my life from then on was going to be spent in finding mistakes in my own programs.","author":"Maurice Wilkes discovers debugging, 1949"},
  "255":
      {"quote":"Debugging is twice as hard as writing the code in the first place. Therefore, if you write the code as cleverly as possible, you areâ€“by definitionâ€“not smart enough to debug it.","author":"Brian Kernighan"},
  "256":
  ...
  "257":
      {"quote":"I donâ€™t care if it works on your machine! We are not shipping your machine!","author":"Vidiu Platon"},
  "258":
  ...
  "260":
      {"quote":"If McDonalds were run like a software company, one out of every hundred Big Macs would give you food poisoning, and the response would be, â€˜Weâ€™re sorry, hereâ€™s a coupon for two more.","author":"Mark Minasi"},
  "261":
  ...
  "263":
      {"quote":"A computer lets you make more mistakes faster than any invention in human historyâ€“with the possible exceptions of handguns and tequila.","author":"Mitch Radcliffe"},
  "264":
      {"quote":"Everything that can be invented has been invented.","author":"Charles H. Duell, Commissioner, U.S. Office of Patents, 1899"},
  "265":
      {"quote":"I think thereâ€™s a world market for about 5 computers.","author":"Thomas J. Watson, Chairman of the Board, IBM, circa 1948"},
  "266":
